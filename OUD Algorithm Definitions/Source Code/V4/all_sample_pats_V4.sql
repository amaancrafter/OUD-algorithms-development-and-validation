...
reviewed_pats_v4 as
(
	select cohort_algorithm.* 
	from 
		cohort_algorithm
		join unc_tracsdata.cc_1171_cohort cohort on cohort_algorithm.patid = cohort.patid and cohort.reviewed=1


)
select * from reviewed_pats_v4
